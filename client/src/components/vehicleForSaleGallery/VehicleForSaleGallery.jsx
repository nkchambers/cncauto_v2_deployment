...
import './VehicleForSaleGallery.css';

const VehicleForSaleGallery = ({ vehicleForSale }) => {
        ...
        return (
            <div className='photoGalleryContainer text-white min-h-screen mt-32'>
                <div className='p-8 grid gap-4 bg-black'>
                    <div className='mb-8'>
                        <h2 className='text-3xl mr-24'>Photos of {vehicleForSale.year} {vehicleForSale.make} {vehicleForSale.model}</h2>
...
export default VehicleForSaleGallery