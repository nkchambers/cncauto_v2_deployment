    ...
    return (
        <>
            ...
            <div className='flex gap-4'>
                <input
                    className='photoLinkInput bg-dark w-full'
                    type="text"
                    value={photoLink}
                ...
                />
                <button
                    className='addPhotoButton rounded-2xl mb-3'
            ...
            <div className='mt-2 grid gap-4 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    <div className='mt-4 h-32 flex relative' key={link}>
                        ...
                        >
                            {link === addedPhotos[0] && (
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-primary1">
                ...
                <label className='flex mb-3 items-center justify-center gap-1 border rounded-2xl px-5 py-10 text-2xl cursor-pointer'>
                    <input
                        type="file"
                        className='hidden'
                        multiple
